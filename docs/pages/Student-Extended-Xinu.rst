...
develop applications for a their own or a provided Xinu operating system
is one of the potential tracks presented for a professor that is
...
`Category:Student Extended Xinu <Category:Student Extended Xinu>`__
