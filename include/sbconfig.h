 ...
 * $Id: sbconfig.h 1576 2008-10-03 18:13:39Z mschul $
 *
...
{
    volatile ulong pad0[2];
    volatile ulong ipsFlag;     /* initiator port ocp slave flag */
    volatile ulong pad1[3];
    volatile ulong tpsFlag;     /* target port ocp slave flag */
    volatile ulong pad2[11];
    volatile ulong tmErrLoga;   /* (sonics >= 2.3) */
    volatile ulong pad3;
    volatile ulong tmErrLog;    /* (sonics >= 2.3) */
    volatile ulong pad4[3];
    volatile ulong adMatch3;    /* address match3 */
    volatile ulong pad5;
    volatile ulong adMatch2;    /* address match2 */
    volatile ulong pad6;
    volatile ulong adMatch1;    /* address match1 */
    volatile ulong pad7[7];
    volatile ulong imState;     /* initiator agent state */
    volatile ulong intVec;      /* interrupt mask */
    volatile ulong tmStateLow;  /* target state */
    volatile ulong tmStateHigh; /* target state */
    volatile ulong bwa0;        /* bandwidth allocation table0 */
    volatile ulong pad8;
    volatile ulong imConfigLow; /* initiator configuration */
    volatile ulong imConfigHigh;        /* initiator configuration */
    volatile ulong adMatch0;    /* address match0 */
    volatile ulong pad9;
    volatile ulong tmConfigLow; /* target configuration */
    volatile ulong tmConfigHigh;        /* target configuration */
    volatile ulong bConfig;     /* broadcast configuration */
    volatile ulong pad10;
    volatile ulong bState;      /* broadcast state */
    volatile ulong pad11[3];
    volatile ulong actCnfg;     /* activate configuration */
    volatile ulong pad12[3];
    volatile ulong flagst;      /* current sbflags */
    volatile ulong pad13[3];
    volatile ulong idLow;       /* identification */
    volatile ulong idHigh;      /* identification */
};
